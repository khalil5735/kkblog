...
- 默认的包结构
  ...
  - 无需以前的包扫描配置
  - 想要改变扫描路径，配置`@SpringBootApplication(scanBasePackages=**"com.atguigu"**)` 或者使用`@ComponentScan` 指定扫描路径
...
![img](./assets/1602835786727-28b6f936-62f5-4fd6-a6c5-ae690bd1e31d.png)
...
![img](./assets/1602845382065-5c41abf5-ee10-4c93-89e4-2a9b831c3ceb.png)
...
![img](./assets/1602922147241-73fb2496-e795-4b5a-b909-a18c6011a028.png)

#### 1、自动依赖引入

![img](./assets/1602921777330-8fc5c198-75da-4ff9-b82c-71ee3fe18af8.png)

#### 2、自动创建项目结构

![img](./assets/1602921758313-5099fe18-4c7b-4417-bf6f-2f40b9028296.png)

#### 3、自动编写好主配置类

![img](./assets/1602922039074-79e98aad-8158-4113-a7e7-305b57b0a6bf.png)
